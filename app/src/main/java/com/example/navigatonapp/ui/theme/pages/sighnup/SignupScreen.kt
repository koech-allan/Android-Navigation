package com.example.navigatonapp.ui.theme.pages
...
@Composable
fun SighnupScreen(navController: NavHostController){
...
fun SignupScreenPreview() {
    NavigatonAppTheme {
        SighnupScreen(rememberNavController())
